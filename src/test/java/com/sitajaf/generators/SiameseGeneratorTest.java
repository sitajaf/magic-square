...
public class SiameseGeneratorTest {
    private SiameseGenerator siameseGenerator;

    @Before
    public void setUp() throws Exception {
        siameseGenerator = new SiameseGenerator();
    }
    ...
    public void shouldReturnMagicSquareOfOrder3() throws Exception {
        ...
        assertThat(siameseGenerator.get(3), is(expectedSquare));
    }
    ...
    public void shouldReturnMagicSquareOfOrder5() throws Exception {
        ...
        assertThat(siameseGenerator.get(5), is(expectedSquare));
    }
    ...
    public void shouldReturnMagicSquareOfOrder9() throws Exception {
        ...
        assertThat(siameseGenerator.get(9), is(expectedSquare));
    }

    @Test
    public void shouldReturnCorrectMagicSquareOfOrder17() throws Exception {
        int[][] square = siameseGenerator.get(17);
